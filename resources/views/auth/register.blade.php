...
<div class="d-flex flex-column flex-column-fluid flex-center w-lg-50 p-10">
  <div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
      ...
      <form class="form w-100" action="{{ route('register') }}" method="POST" id="loginForm">
        ...
        <div class="card-body">
          <div class="text-start mb-10">
            ...
            <div class="text-gray-500 fw-semibold fs-6">Welcome!, Please enter your detail </div>
          </div>
          ...
          <div class="fv-row mb-10" data-kt-password-meter="true">
            ...
            <div class="mb-1">
              ...
              <div class="position-relative mb-3">
                <input class="form-control form-control-lg form-control-solid @error('password') is-invalid @enderror" type="password" placeholder="Password" name="password" autocomplete="off" data-kt-translate="sign-up-input-password" />
    ...
    <div class="m-0 text-center">
      <span class="text-gray-500 fw-bold fs-5 me-2" data-kt-translate="sign-up-head-desc">Already have an account ?</span>
      <a href="{{ route('login') }}" class="link-primary fw-bold fs-5">Sign In</a>
    </div>
  </div>
</div>
@endsection
