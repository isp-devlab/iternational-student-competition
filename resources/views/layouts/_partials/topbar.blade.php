  ...
  <div class="app-container container-fluid d-flex align-items-stretch flex-stack mt-lg-8" id="kt_app_header_container">
    ...
    <div class="app-navbar flex-lg-grow-1 pb-5" id="kt_app_header_navbar">
      ...
      <div class="app-navbar-item ms-1 ms-md-3">
        <div class="btn btn-flex btn-icon align-self-center fw-bold btn-secondary w-35px h-35px w-md-40px h-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
      ...
      <div class="app-navbar-item ms-1 ms-md-3" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="50px, -40px">
